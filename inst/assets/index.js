...
const bindScroll = (params, endpoints) => {
  ...
  $(`#${params.ns}-scrollable`).on("scroll", () => {
    ...
    endpoints.fetchLeast().then((data) => {
      ...
      (0,_render__WEBPACK_IMPORTED_MODULE_0__.renderPills)(params, data.slice(n, to));
  ...
  return (event) => {
    ...
    debounce = setTimeout(() => {
      ...
      endpoints.fetchLeast().then((data) => {
        ...
        (0,_render__WEBPACK_IMPORTED_MODULE_0__.renderPills)(params, data.slice(0, 100));
      });
    }, 500);
  };
};
